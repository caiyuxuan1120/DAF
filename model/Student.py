...
# from torchvison.utils._internally_replaced_utils import load_state_dict_from_url
...
class ResNet(nn.Module):
    ...
    def _forward_impl(self, x: Tensor) -> Tensor:
        ...
        # lay4_out = self.layer4(lay3_out)


        return lay1_out, lay2_out, lay3_out

    def forward(self, x: Tensor) -> Tensor:
        lay1_out, lay2_out, lay3_out = self._forward_impl(x)
...
def STUdent(pretrained: bool = False, progress: bool = True, **kwargs: Any) -> ResNet:
